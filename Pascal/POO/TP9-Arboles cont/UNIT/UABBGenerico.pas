...
type
	...
	Nodo = class
		...
		public
			...
			function getElemento(): ClaveDato;
			...
			procedure hacerAlgo(min, max: Comparable); virtual;
		end;	
...
////////////////////////////////////////////////////////////////////////
	...
	begin
	if n.getElemento().getClave().lessThan(elemento.getClave())  then
		begin
		if hayhijoizq then
			hijoizq.agregar(n)
		else
	...
	function Nodo.getElemento(): ClaveDato;
	begin
	...
	begin	
	if elemento.getClave().equals(unaClave) then
		buscarElemento:= elemento.getDato()
	else
	if unaClave.lessThan(elemento.getClave()) then
		begin
		if hayhijoizq then
	...
	if (elemento.getClave().greaterThanOrEquals(unaClave)) then
		...
		writeln(elemento.getDato().toString());
		if self.tenesHijoDer() then
	...
	procedure Nodo.hacerAlgo(min, max: Comparable);
	begin
	//No hace nada
	end;
